...
RANDOM_SEED = 495 # I guessed it, and it's spectacular, with an armageddon at step 22K.
# But you can try also these:
#RANDOM_SEED = 345 # 34/34 bomb neutralized (step 14K)
#RANDOM_SEED = 6590 # a war between two evolved species (37/238 vs 37/23). Guess who won at step 87K?
